...
CREATE TABLE `defectstatus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_gwkuf7cyss1rxocgkg499u06n` (`name`)
...
INSERT INTO `defectstatus` VALUES (1,'New','NewDescription'),(2,'Open','OpenDescription'),(3,'Fixed','FixedDescription'),(4,'Closed','ClosedDescription');
...
-- Dump completed on 2019-12-04 14:28:50
