...
CREATE TABLE `submodule` (
  `sub_module_id` varchar(255) NOT NULL,
  `sub_module_name` varchar(255) DEFAULT NULL,
  `module_id` varchar(255) NOT NULL,
  PRIMARY KEY (`sub_module_id`),
  KEY `FKr4g99idxn9hes5pwu0vpg526b` (`module_id`),
  CONSTRAINT `FKr4g99idxn9hes5pwu0vpg526b` FOREIGN KEY (`module_id`) REFERENCES `module` (`module_id`)
...
INSERT INTO `submodule` VALUES ('S001','QADashboard','M001');
...
-- Dump completed on 2019-12-04 14:29:01
