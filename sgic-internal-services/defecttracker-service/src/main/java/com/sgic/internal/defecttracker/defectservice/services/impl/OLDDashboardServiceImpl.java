...
//		low = defectRepository.countBySeverity(count);
...
//	public Integer countLow(Long projectId) {
//		return defectRepository.countBySeverity(projectId);
//	}
//
//	@Override
...
//	@Override
//	public Integer countseveritytotalLow(long countseveritylow, int rejectseveritylow,Long projectId) {
